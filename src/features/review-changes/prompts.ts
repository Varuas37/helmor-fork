...
export function buildReviewAgentPrompt({
	...
	return [
		...
		"- Use severity `high` for anything that should block the fix flow; Helmor will convert it into a blocking diff comment.",
		"- Use severity `warning`, `suggestion`, or `info` for non-blocking comments.",
